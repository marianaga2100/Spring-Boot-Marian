package org.marian.garciaa.controller;
...
import org.marian.garciaa.service.IntCategoriasService;
import org.marian.garciaa.service.IntVacantesService;
import org.marian.garciaa.util.Utileria;
	...
	public String guardar(Vacante vacante, 
		...
		if (result.hasErrors()) {
			...
			if (!multiPart.isEmpty()) {
				...
				// Linux/MAC
				String ruta = "/Spring-Boot-Marian/img-vacantes/"; // Windows
